...
void UserAppRun(void)
{
   ...
   static u16 au16Notes[]={C4,NN,C4,NN,G4,NN,G4,NN,A4,NN,A4,NN,G4,NN,F4,NN,F4,NN,E4,NN,E4,NN,D4,NN,D4,NN,C4,NN};  //freq
   static u16 au16NoteDuration[]={N4,RT,N4,RT,N4,RT,N4,RT,N4,RT,N4,RT,N2,RT,N4,RT,N4,RT,N4,RT,N4,RT,N4,RT,N4,RT,N2,RT};  //time
   
   if(u16Counter==au16NoteDuration[u8Index])
   {
       
        InterruptTimerXus(au16Notes[u8Index+1],true);
